      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          bsCollapse(
            ...
            bsCollapsePanel(
              title = tagList(h3(id = 'ID_SHOTZONEBASIC', 'SHOT_ZONE_BASIC')),
              p('Shot zones: '),
              tags$ul(
            ...
            bsCollapsePanel(
              title = tagList(h3(id = 'ID_SHOTZONEAREA', 'SHOT_ZONE_AREA')),
            ...
            bsCollapsePanel(
              title = tagList(h3(id = 'ID_ASTDTOT', 'ASTD_TOT')),
            ...
            bsCollapsePanel(
              title = tagList(h3(id = 'ID_PCTASTD', 'PCT_ASTD')),
